...
This repo was built on top of this repo - [React & Google Apps Script](https://github.com/enuchi/React-Google-Apps-Script). The original uses Google Sheets as the default. This repo uses Google Docs as the default.
